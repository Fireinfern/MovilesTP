...
Game.prototype = {
	create:function(){
		...
		this.showScores = this.game.add.text(50, this.game.height - 50, "Show Scores")
		this.showScores.fill = "#FFFFFF";
		this.showScores.inputEnabled = true;
		this.showScores.visible = false;
		this.showScores.events.onInputDown.add(this.goToScores, this);
	...
	collision:function(sprite1,sprite2){
		...
		this.database.ref("/trabajoParcial/" + id.toString(16)).set({
			created_at: date,
			score: this.score,
